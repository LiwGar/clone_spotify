 ...
 const Popular = () => {
    ...
    >
        <div className="mb-4 relative max-sm:flex max-sm:items-center max-sm:justify-center sm:flex sm:justify-center md:flex md:items-center md:justify-center">
            <Image 
                src="https://pbs.twimg.com/profile_images/1686776068215128075/J2yJCaMy_400x400.jpg"
                width={200}
                height={200}
                alt="artist"
        ...
        <div className="items-start">
                <h5 className="text-md font-bold text-spotify-white mb-1">Swedish House Mafia</h5>
