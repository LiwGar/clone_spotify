 ...
 const Card = () => {
    ...
    >
        <div className="mb-4 relative max-sm:flex max-sm:items-center max-sm:justify-center sm:flex sm:justify-center md:flex md:items-center md:justify-center">
            <Image 
                src="https://lastfm.freetls.fastly.net/i/u/500x500/d2eec9d57029ed14a90af124c5aba52c.jpg"
                width={170}
                height={170}
                alt="album"
        ...
        <div className="items-start">
                <h5 className="text-md font-bold text-spotify-white mb-1">Lullaby</h5>
                <p className="text-sm font-semibold">R3HAB, Mike Williams</p>
        </div>
    </Link>
    )
 }
